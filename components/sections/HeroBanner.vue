<template>
    <section id="hero" ref="hero" style="height: calc(100vh - 77px)" class="section bg-dark position-relative">
        ...
        <div class="hero-wrap">
            ...
            <b-button variant="primary" class="hero-btn" @click="$refs.about.scrollIntoView()">Let's Start</b-button>
        </div>
    </section>
</template>
